...
//Esta variante la voy a utilizar de bandera para saber si ya ejecuto la animación
let entro = false;

//Función que aplica la animación de habilidades
...
function pintarBarra(id_barra, cantidad, indice, interval){
    ...
    if(x < cantidad){
        ...
        elementos[x].style.backgroundColor = "#05c7f8f6";
    }else{
